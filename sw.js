const CACHE = 'unified-industrial-cbt-v265';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=265',
  ...
  './modern/cbt.css?v=265', './modern/cbt.js?v=265', './modern/visitor.js?v=255',
