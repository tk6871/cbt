const CACHE = 'unified-industrial-cbt-v231';
const CORE = [
  './', './index.html', './jewelry.html', './legacy.html', './next.html', './manifest.webmanifest',
  './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './data/hvac.js?v=231', './data/safety.js?v=231', './data/energy.js?v=231', './data/energy-engineer.js?v=231',
  './data/maintenance.js?v=231', './data/jewelry.js?v=231', './data/changelog.js?v=231', './data/changelog-vue.js?v=231',
  ...
  './app.css?v=231', './app.js?v=231',
  './modern/cbt.css?v=231', './modern/cbt.js?v=231', './modern/visitor.js?v=231',
