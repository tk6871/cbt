const CACHE = 'unified-industrial-cbt-v232';
const CORE = [
  './', './index.html', './jewelry.html', './legacy.html', './next.html', './manifest.webmanifest',
  './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './data/hvac.js?v=232', './data/safety.js?v=232', './data/energy.js?v=232', './data/energy-engineer.js?v=232',
  './data/maintenance.js?v=232', './data/jewelry.js?v=232', './data/changelog.js?v=232', './data/changelog-vue.js?v=232',
  ...
  './app.css?v=232', './app.js?v=232',
  './modern/cbt.css?v=232', './modern/cbt.js?v=232', './modern/visitor.js?v=232',
