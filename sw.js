const CACHE = 'unified-industrial-cbt-v259';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=255',
  ...
  './modern/cbt.css?v=255', './modern/cbt.js?v=255', './modern/visitor.js?v=255',
