const CACHE = 'unified-industrial-cbt-v261';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=257',
  ...
  './modern/cbt.css?v=257', './modern/cbt.js?v=257', './modern/visitor.js?v=255',
