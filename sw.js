const CACHE = 'unified-industrial-cbt-v260';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=256',
  ...
  './modern/cbt.css?v=256', './modern/cbt.js?v=256', './modern/visitor.js?v=255',
