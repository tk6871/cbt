const CACHE = 'unified-industrial-cbt-v271';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=271',
  ...
  './modern/cbt.css?v=271', './modern/cbt.js?v=271', './modern/visitor.js?v=255',
