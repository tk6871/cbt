const CACHE = 'unified-industrial-cbt-v300';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=300',
  ...
  './modern/cbt.css?v=300', './modern/cbt.js?v=300', './modern/visitor.js?v=255',
