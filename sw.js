const CACHE = 'unified-industrial-cbt-v272';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=272',
  ...
  './modern/cbt.css?v=272', './modern/cbt.js?v=272', './modern/visitor.js?v=255',
