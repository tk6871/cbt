const CACHE = 'unified-industrial-cbt-v350';
const CORE = [
  './', './index.html', './jewelry.html', './next.html', './manifest.webmanifest', './jewelry.webmanifest',
  './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './data/catalog-index.js?v=350', './data/catalog-bootstrap.js?v=350',
  './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=350',
  ...
  './modern/cbt.css?v=350', './modern/cbt.js?v=350', './modern/mobile.js?v=350', './modern/visitor.js?v=255',
  './modern/chunks/import-wrapper-prod-v350.js', './modern/chunks/index-v350.js',
  './modern/chunks/preload-helper-v350.js', './modern/chunks/web-v350.js',
