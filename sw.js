const CACHE = 'unified-industrial-cbt-v252';
const CORE = [
  './', './index.html', './jewelry.html', './legacy.html', './next.html', './manifest.webmanifest',
  './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './data/hvac.js?v=252', './data/safety.js?v=252', './data/energy.js?v=252', './data/energy-engineer.js?v=252',
  './data/maintenance.js?v=252', './data/jewelry.js?v=252', './data/changelog.js?v=252', './data/changelog-vue.js?v=252',
  './calculator.html', './calculator.css?v=252', './calculator.js?v=252', './vendor/math.js?v=194',
  './admin.html', './cloud-config.js?v=200', './관리자_방문기록_설정방법.txt',
  './app.css?v=252', './app.js?v=252',
  './modern/cbt.css?v=252', './modern/cbt.js?v=252', './modern/visitor.js?v=252',
  './modern/chunks/import-wrapper-prod.js', './modern/chunks/index.js',
  './modern/assets/search.worker-BqvfbZXG.js',
  './modern/assets/king-size-homer-DOPAnXmh.jpg',
