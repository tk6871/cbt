const CACHE = 'unified-industrial-cbt-v266';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=266',
  ...
  './modern/cbt.css?v=266', './modern/cbt.js?v=266', './modern/visitor.js?v=255',
