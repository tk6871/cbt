const CACHE = 'unified-industrial-cbt-v263';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=263',
  ...
  './modern/cbt.css?v=258', './modern/cbt.js?v=263', './modern/visitor.js?v=255',
