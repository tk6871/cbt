const CACHE = 'unified-industrial-cbt-v280';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=280',
  ...
  './modern/cbt.css?v=280', './modern/cbt.js?v=280', './modern/visitor.js?v=255',
