const CACHE = 'unified-industrial-cbt-v273';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=273',
  ...
  './modern/cbt.css?v=273', './modern/cbt.js?v=273', './modern/visitor.js?v=255',
