const CACHE = 'unified-industrial-cbt-v291';
const CORE = [
  ...
  './data/maintenance.js?v=255', './data/jewelry.js?v=255', './data/changelog.js?v=255', './data/changelog-vue.js?v=291',
  ...
  './modern/cbt.css?v=291', './modern/cbt.js?v=291', './modern/visitor.js?v=255',
