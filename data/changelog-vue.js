(function () {
  ...
  const entries = [
    {
      ...
      scope: 'industrial',
      date: '2026.08.01',
      title: '공조·산업안전·설비보전 이미지 선명도 통일',
      summary: '공조 이미지를 Mac 256px 타일 기준으로 다시 처리하고 산업안전·설비보전의 수식과 도표 이미지도 같은 초해상도 방식으로 개선했습니다.',
      tags: ['공조냉동', '산업안전', '설비보전', '이미지 개선'],
      changes: [
        ...
        '산업안전과 설비보전의 기존 GIF 원본은 그대로 보존하고 문제 데이터의 이미지 연결만 개선된 PNG로 변경했습니다.',
        '공조·산업안전·에너지관리·설비보전 이미지에 Real-ESRGAN 4배 처리 후 bicubic 2배 축소 기준을 적용했습니다.',
  ...
  changelog.versions.industrial = '2.3.11';
  changelog.versions.jewelry = '2.3.4';
  changelog.currentVersion = '2.3.11';
