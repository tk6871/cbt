  ...
  const entries = [
    {
      ...
      tags: ['필답형', '이미지 보완', 'PDF·스캔 원문 대조'],
      changes: [
        '2026년 1·2회 24문항은 기존 영상 캡처 대신 사용자 제공 해설 PDF에서 분리한 문제18·답안7 그림을 사용합니다.',
        '기존 2026년 영상 캡처는 제거했지만 문제 ID·작성 답안·학습 기록은 그대로 유지합니다.',
        '2회11번을 액순환식 증발기와 리키드백 방지 문제로 교정하고, 1번 표시등·12번 스크롤 압축기 풀이를 보강했습니다.',
        '2023년 3회~2024년 2회 해설 스캔 21장을 문제 내용으로 대조해 순서가 다른 36문항을 연결하고 도면·표·사진25개를 보완했습니다.',
        '2023년 3회8번은 전자밸브 문제로, 2024년 1회9번은 실내20℃·답15℃/0.004 kg/kg(DA)인 스캔 원문으로 교정했습니다.',
        '필답형 자료·범위에 추가 자료42와 사진·기기 자료123 묶음을 넣었습니다. 입력·손글씨·암기·복습으로 풀 수 있고 기존407문제를 보존해 전체572문제입니다.',
        '사진·기기 자료는 PDF 원본 사진95개와 학습 설명을 연결했습니다. 정답이 적힌 비교 사진2개는 문제와 답안으로 분리하고 원문의 계측기·압력스위치 등 오류를 보완했습니다.',
        '새 자료의 그림2개를 원본 PDF에서 분리하고 가열 그래프 답안, 누락된 백연 설명, 계산 단위와 오래된 안전 안내를 보완했습니다. 공식 기출 회차나 공식 채점표는 아닙니다.',
        '2024년 1회1·6번, 2회1·2·5·7·8·10번, 3회1·2번, 2025년 1회1번, 2회1·2·5번, 3회3번, 2026년 2회3번의 문제 또는 답안 그림을 보완했습니다.',
        '잘린 회로 접점·공통선·계전기 단자·타임차트 마지막 열·부하표 열과 계산식 끝부분을 원본 영상 장면에서 복구했습니다.',
        '멀티테스터는 1~4 표시가 있는 기기 사진에 집중하고 측정 조건 네 가지는 기존 문제 본문에 유지합니다.',
        '기존 문제·정답·해설·작성 답안은 유지하며 2026년 외 원본 이미지는 보존합니다.',
        '연결 이미지 258개를 검수했지만 모든 원문 대조와 수정이 끝난 것은 아닙니다. 남은 가림·원본 부족 항목은 계속 보완합니다.'
      ]
    },
    {
      version: '5.1.3', scope: 'industrial', date: '2026.09.14',
      title: '필답형 복원 자료 기간 선택',
      summary: '전체 기간·2023년 2회 이후·이전 자료를 골라 학습하고 같은 범위로 랜덤 실전을 시작합니다.',
      tags: ['필답형', '자료 구분', '범위 선택'],
      changes: [
        '필답형 상단에 전체 기간(기본), 2023년 2회 이후 120문제, 2023년 1회 이전 192문제 선택을 추가했습니다.',
        '선택 기간에 맞춰 회차 목록과 검색·복습·오늘의 5문제·랜덤 실전 범위를 함께 좁힙니다.',
        '기간 밖의 회차 선택은 전체 회차로 전환하며, 기존 답안과 학습 기록은 유지합니다. 새로고침 뒤 기간과 회차를 복원합니다.',
        '원본 영상으로 대조할 수 있는 자료 시점을 구분한 것이며 시험 제도 변경이나 전체 이미지 검수 완료를 뜻하지 않습니다.',
        '2023년 2회1번의 누락된 제어회로와 3회1번의 잘린 우측 회로를 원본 영상의 실제 장면으로 복구했습니다. 기존 파일은 보존합니다.'
      ]
    },
    {
    ...
    },
    {
      ...
      tags: ['S펜 수정', '큰 답안지', '기록 보호', '해설 출처'],
      changes: [
        '손가락 이동과 펜 입력을 분리하여 브라우저 스크롤 때문에 펜이 첫 점에서 끊기는 문제를 수정했습니다.',
        '지우개는 필기만 지우며 배경 줄과 겹쳐 본 정답 도면은 유지합니다.',
        '답안지 기본 세로 길이를 늘리고 크게 쓰기·아래 늘리기를 추가했습니다. 기존 필기는 늘어나거나 찌그러지지 않습니다.',
        '동기화의 서버 읽기·비교·저장·반영 단계를 표시하고, 동시에 저장한 기기가 있으면 다시 비교합니다.',
        '다른 풀이 사본을 현재 브라우저에 최근 100건까지 보관합니다. 설정에서 원하는 풀이만 복구하거나 파일로 보관할 수 있습니다. 손글씨는 기기 내 저장입니다.',
        '해설의 기록된 출처를 COMCBT 이용자·기존 문항 연결·학습용 작성·AI 보강으로 구분합니다. 출처가 불명확하면 확인 필요로 표시합니다.',
        '필답 학습용 채점에서 같은 값의 SI 단위 환산을 비교하고 소수점으로 채점 항목이 쪼개지는 문제를 수정했습니다. 공식 채점 기준은 아닙니다.'
      ]
    },
    {
      version: '4.0.1', scope: 'jewelry', date: '2026.09.10',
      title: '동기화 기록 보호와 해설 출처 안내',
      summary: '동기화 단계를 확인하고 다른 풀이 사본을 복구할 수 있으며, 해설 작성 출처를 구분합니다.',
      tags: ['동기화', '풀이 복구', '해설 출처'],
      changes: ['동시 저장 충돌 시 최신 서버 기록을 다시 비교합니다.', '설정의 다른 풀이 사본·복구에서 최근 100건의 기기 내 사본을 확인합니다.', '문제 출처와 해설 출처를 구별하여 표시합니다.']
    },
    {
      version: '5.1', scope: 'industrial', date: '2026.09.10',
      title: '필답형 CBT 화면과 답안 작성 보강',
      summary: '필답형을 익숙한 CBT 흐름으로 정리하고 한 문제·2문제·4문제·연속 보기와 넓은 답안지를 제공합니다.',
      tags: ['필답형 CBT', '여러 문제 보기', 'S펜', '4K 대응'],
      changes: [
        '필답형과 필기 공식 자료를 탭으로 나누고, 학습 현황·범위·도우미는 필요한 때 펼칩니다.',
        '한 문제씩, 2문제씩, 4문제씩, 여러 문제 이어보기를 선택할 수 있습니다. 문제 번호 이동과 미작성 이동을 제공합니다.',
        '이전·답안 확인·다음 조작을 하단에 모으고, 넓은 창은 문제와 답안 2열, 좁은 창은 세로 배치를 사용합니다.',
        '입력 답안과 보기 위치를 보존하며, 핵심 답안과 이해용 설명을 구분해 설명은 눌러서 펼칩니다.',
        '손글씨 답안지 확대·손가락 이동 모드를 추가하고, 다른 포인터가 펜 입력을 끊는 현상을 방지했습니다. 손글씨는 해당 기기에 저장됩니다.',
        '학습용 부분점수표의 자동 감지를 직접 해제할 수 있으며 숫자·단위의 부분 문자열 오인식을 줄였습니다.',
        '계산 문제는 공식·대입·계산·단위 중 막힌 단계만 별도로 연습하고 기존 해설과 비교할 수 있습니다.',
        '연속 보기의 순차 표시, 화면 근처 손글씨 답안지 실행, 학교 준비 화면 지연 로딩으로 불필요한 실행을 줄였습니다. 원본 문제·해설은 변경하지 않습니다.'
      ]
    },
    {
    ...
    },
    {
      ...
      scope: 'industrial',
      date: '2026.09.05',
      title: '공조 필답형 실전 채점과 S펜 훈련 강화',
      summary: '필답형 답안을 직접 작성한 뒤 핵심어·숫자·단위·도면을 부분점수 기준으로 확인하고, 오답 재작성과 기기 간 이어하기까지 연결했습니다.',
      tags: ['공조 필답형', '부분점수', 'S펜', '오늘의 5문제', '실수 분석', '답안 동기화'],
      changes: [
        '오답·부분점수·미학습 문제를 우선하는 오늘의 필답 5문제와 같은 유형 연속 훈련을 추가했습니다.',
        '문제에서 요구한 개수·계산·단위·도면 조건을 먼저 표시하고 계산형·서술형·도면형에 맞는 답안 골격을 넣을 수 있습니다.',
        '첫 글자부터 핵심어와 답안 구조까지 필요한 만큼만 여는 3단계 힌트, 핵심어 빈칸과 역문제 훈련을 제공합니다.',
        '내 답에서 채점 핵심어·숫자·단위를 찾아 표시하고 직접 체크를 보완해 문제별 예상 부분점수를 계산합니다.',
        '공식·대입·계산·단위·핵심어·개수·도면·시간 부족을 기록하고 실전 종료 후 취약 분야와 반복 실수를 알려 줍니다.',
        '빠진 채점 요소만 다시 쓰는 오답 수술과 최근 입력 답안 3회의 점수·내용 비교를 추가했습니다.',
        'S펜 답안지에 펜 버튼 지우개, 왼손 배치, 작성 과정 재생, 정답 도면 투명 겹치기와 촬영 답안 비교를 추가했습니다.',
        '현재 선택한 필답 문제를 문제당 별도 답안 공간이 있는 A4 시험지로 출력할 수 있습니다.',
        '입력 답안과 채점표·실수·힌트·최근 답안 이력을 기존 로그인 동기화에 포함해 PC·태블릿·휴대폰 기록을 문제별 최신 시각으로 합칩니다.',
        '신기술 학습관에 새 필답형 기능과 사용 위치를 정리하고 서비스워커 캐시 v480, Android 앱 v4.8을 적용했습니다.'
      ]
    },
    {
      version: '4.7',
    ...
    },
    {
      ...
      date: '2026.08.31',
      title: '동기화 계정 가입과 복구',
      summary: '이메일 없이 사이트 아이디로 가입하고 복구코드나 임시 비밀번호로 계정을 되찾을 수 있습니다.',
      tags: ['기기 간 동기화', '회원가입', '복구코드', '임시 비밀번호'],
      changes: [
        '로그인하지 않아도 기존처럼 모든 문제를 풀 수 있고, 원하는 사용자만 무료 동기화 계정을 만들 수 있습니다.',
        '이메일을 입력하거나 메일을 기다리지 않고 사이트 아이디와 비밀번호만으로 가입·로그인할 수 있습니다.',
        '가입할 때 한 번 표시되는 복구코드로 아이디를 확인하거나 비밀번호를 바로 바꿀 수 있습니다.',
        '복구코드도 잊었다면 운영자에게 임시 비밀번호를 요청해 로그인한 뒤 설정에서 새 비밀번호로 바꿀 수 있습니다.',
    ...
    },
    {
      ...
      changes: [
        ...
        'COMCBT 동일 문제는 실제 분류·공식·암기 설명을 읽기 좋게 다듬어 첫 해설에 표시하고 원문은 추가 해설로 보존했습니다.',
        '한솔·COMCBT·공조 복원에서 같은 문제를 찾아 기존 해설을 지우지 않고 출처별 추가 해설로 연결했습니다.',
        '산업안전·에너지관리·설비보전의 비어 있거나 정답만 적힌 해설을 개념·공식 중심으로 보강했습니다.',
        '계산문제 쉽게 풀어보기에서 공식과 겹치던 왜?·기호 항목을 빼고 숫자 출처·계산 순서·단위만 간결하게 표시합니다.',
