(function () {
  ...
  const entries = [
    {
      ...
      scope: 'industrial',
      date: '2026.08.14',
      title: '더 짧은 문제 배치와 복원 답안 정밀 재검수',
      summary: '짧은 문제 때문에 옆 카드까지 길어지지 않도록 독립 열로 재배치하고, 일반 보기와 공조 복원 이미지 답안을 더 빠르고 정확하게 선택하도록 다듬었습니다.',
      tags: ['문제 배치', '간결한 답안', '복원문제 전수 검사', '해설 교정'],
      changes: [
        ...
        '공조 복원문제 1,019장·4,076개 답안을 PaddleOCR과 원본 픽셀로 다시 대조해 글자 잘림·누락·답안 박스 겹침이 0건인지 확인했습니다.',
        '두 줄·세 줄·수식 보기 763개가 첫 줄만 남지 않도록 5,024개 OCR 조각을 다시 연결했습니다.',
        '자동 인식이 불안한 수식·도표 47개 답안은 원본을 직접 확인한 별도 좌표로 고정했습니다.',
        '2023년 1회 60번의 문제와 보기를 원문대로 정리하고, 정답 ③ 가스설비에 맞지 않던 해설을 초보자용 설명으로 교정했습니다.',
        '서비스워커 캐시를 v272로 갱신했습니다.'
      ]
    },
    {
      version: '2.6',
  ...
  changelog.versions.industrial = '2.7';
  changelog.versions.jewelry = '2.5.6';
  changelog.currentVersion = '2.7';
