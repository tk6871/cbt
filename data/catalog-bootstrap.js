(function () {
  ...
  var allowed = ["hvac", "hvac-hansol", "safety", "energy", "maintenance", "electric-craftsman", "gas-craftsman", "hazardous-craftsman", "information-engineer", "school-exams"];
  ...
  var scripts = qualification === "school-exams" ? [] : ["data/" + qualification + ".js?v=420"];
  if (qualification === "energy") scripts.push("data/energy-engineer.js?v=420");
