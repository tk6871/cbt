...
- 이번 문서에는 전 종목 이미지 개선, 문제·이미지 정밀 검수, 선택형 테마·동적 화면 전환, v2.7 간결한 문제 배치, v2.8 선택형 문제풀이 화면, v2.9 Android 전용 앱, v3.0 기기 동기화와 v3.1 복원문제 원본 전수 검수·학습 이어하기 상태가 포함됨
...
- 산업기사·보석관 패치노트 v3.1과 Service Worker 캐시 v310까지 반영했습니다.
