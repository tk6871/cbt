...
- 마지막 갱신: 2026-08-01
- 기준 브랜치: `main`
- 이번 Mac 작업 직전 Git HEAD: `4976a49`
- 이번 문서에는 전 종목 이미지 개선, 선택형 심슨 UI와 계산기 스킨 작업 및 실제 Mac 검증 결과가 포함됨
...
현재 조사된 공조·산업안전·에너지관리·설비보전·보석관 이미지 개선 후보는 모두 처리했습니다. 다음 UI 작업은 사용자가 v2.4.4 실제 화면을 확인한 뒤 원하는 부분을 조정합니다.
