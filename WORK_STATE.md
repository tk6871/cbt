...
- 마지막 갱신: 2026-08-01
- 기준 브랜치: `main`
- 이번 Mac 동적 UI 작업 직전 Git HEAD: `ffd8772`
- 이번 문서에는 전 종목 이미지 개선, 선택형 심슨 UI, 계산기 스킨, 동적 화면 전환과 실제 Mac 검증 결과가 포함됨
...
- 패치노트 v2.4.4와 Service Worker 캐시 v247까지 반영했습니다.
...
현재 조사된 공조·산업안전·에너지관리·설비보전·보석관 이미지 개선 후보와 v2.4.4 동적 UI 작업을 처리했습니다. 다음 작업은 사용자가 실제 화면을 확인한 뒤 원하는 세부 속도·배치·기능을 조정합니다.
