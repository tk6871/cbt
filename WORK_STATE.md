...
- 마지막 갱신: 2026-08-08
- 기준 브랜치: `main`
- 이번 CBT 수정 작업 시작 Git HEAD: `fa3112e`
- 이번 문서에는 전 종목 이미지 개선, 선택형 심슨 UI, 동적 화면 전환과 v2.4.5 핵심 CBT 기능 변경 상태가 포함됨
...
- 패치노트 v2.4.5와 Service Worker 캐시 v248까지 반영했습니다.
...
`CBT수정안.docx`의 1차 필수 기능 가운데 답안 선택 취소, 킵, 회차별 기록·오답, 북마크 알림, 글자 크기, 태블릿 종목 선택, Q-Net 합격 기준, OMR 축소와 모바일 경량화를 구현했습니다. 다음 작업은 실제 태블릿·모바일 확인 후 남은 테마 개선, 계산 문제 전용 학습, 공조 암기 자료, 전 문제 검증과 베타 CBT UI 3종을 순서대로 진행합니다.
